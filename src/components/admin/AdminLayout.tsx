    ...
    <div className="min-h-screen bg-[#050811] text-[#e0e7ff] flex flex-col font-inter selection:bg-[#00f0ff] selection:text-black relative overflow-x-hidden">
      ...
      <div className="relative z-10 flex-1 flex h-screen overflow-hidden">
        ...
        <div className="flex-1 flex flex-col h-full overflow-hidden">
          ...
          <header className="bg-[#0d1b2b]/70 border-b border-[#00f0ff]/20 px-4 sm:px-6 py-2.5 flex items-center justify-between shrink-0 backdrop-blur-md z-20 gap-4">
            {/* Mobile Menu Button + Title */}
            <div className="flex items-center gap-3">
              <button
                onClick={() => setIsMobileMenuOpen(true)}
                className="p-2 rounded-xl bg-[#0d1b2b] border border-[#00f0ff]/30 text-[#00f0ff] lg:hidden hover:bg-[#00f0ff]/20"
                title="Toggle menu"
              >
            ...
            <div className="flex items-center gap-3">
              ...
              {currentUser ? (
                <div className="flex items-center gap-2 bg-[#0d1b2b]/80 border border-emerald-500/30 rounded-xl px-3 py-1.5">
          ...
          <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 bg-[#050811]/90 scrollbar-thin scrollbar-thumb-[#00f0ff]/20 font-inter">
            <Outlet />
          </main>
        </div>
      </div>
